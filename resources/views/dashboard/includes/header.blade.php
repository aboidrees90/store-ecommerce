        ...
        <ul class="nav navbar-nav float-right">
          ...
          <li class="dropdown dropdown-language nav-item">
            <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#" data-toggle="dropdown" aria-haspopup="true"
               aria-expanded="false">
              <i class="flag-icon flag-icon-{{getCurrentLocaleCountryCode(LaravelLocalization::getCurrentLocaleRegional())}}"></i>
            ...
            <div class="dropdown-menu" aria-labelledby="dropdown-flag">
              @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                ...
                >
                  <i class="flag-icon flag-icon-{{getCurrentLocaleCountryCode($properties['regional'])}}"></i> {{$properties['native']}}
                </a>
              @endforeach
            </div>
          </li>
