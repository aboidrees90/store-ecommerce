<!DOCTYPE html>
<html class="loading" lang="{{ app()->getLocale() }}" data-textdirection="{{ getDirection() }}">
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/' . getDirection('css') . '/plugins/animate/animate.css') }}">
  <!-- BEGIN VENDOR CSS-->
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/' . getDirection('css') . '/vendors.css') }}">
  ...
  <link rel="stylesheet" type="text/css"
    href="{{ asset('assets/admin/' . getDirection('css') . '/core/menu/menu-types/vertical-menu.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/' . getDirection('css') . '/pages/chat-application.css') }}">
  <!-- END VENDOR CSS-->
  <!-- BEGIN MODERN CSS-->
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/' . getDirection('css') . '/app.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/' . getDirection('css') . '/' . getDirection('custom') . '.css') }}">
  <!-- END MODERN CSS-->
  <!-- BEGIN Page Level CSS-->
  <link rel="stylesheet" type="text/css"
    href="{{ asset('assets/admin/' . getDirection('css') . '/core/menu/menu-types/vertical-menu.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/' . getDirection('css') . '/core/colors/palette-gradient.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/fonts/simple-line-icons/style.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/' . getDirection('css') . '/core/colors/palette-gradient.css') }}">
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/' . getDirection('css') . '/pages/timeline.css') }}">
  ...
  <!-- END Page Level CSS-->
  <!-- BEGIN Custom CSS-->
  <link rel="stylesheet" type="text/css" href="{{ asset('assets/admin/' . getDirection('css') . '/' . getDirection('style') . '.css') }}">
  <!-- END Custom CSS-->
  @notify_css
  @yield('style')
