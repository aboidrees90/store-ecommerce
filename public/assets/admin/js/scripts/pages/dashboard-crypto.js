...
(function (window, document, $) {
    ...
    ********************************************/
    ...
    var newChartjs = document.getElementById("new-chartjs").getContext("2d");
    // Create Linear Gradient
    var green_trans_gradient = newChartjs.createLinearGradient(0, 0, 0, 100);
    green_trans_gradient.addColorStop(0, 'rgba(30,242,159,0.4)');
    green_trans_gradient.addColorStop(1, 'rgba(255,255,255,0)');
    ...
    var NEWAreaChart = new Chart(newChartjs, NEWCardconfig);
